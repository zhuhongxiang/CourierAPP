...
import com.example.courierapp.adapter.CabinetAdapter;
import com.example.courierapp.entity.Cabinet;
...
public class DeliverySelectCabActivity extends Activity {
    ...
    private static final String URL_NUMBER = URL_HEAD+"/delivery/cabinfo";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_delivery_select_cab);
        initView();
        initEvent();
    }
    ...
    private void initEvent() {
        lv_cab.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                Intent intent = new Intent(DeliverySelectCabActivity.this, DeliveryDetailActivity.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URL_NUMBER,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (code.equals("0")){
                                ...
                                Toast.makeText(DeliverySelectCabActivity.this,"查询成功",Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(DeliverySelectCabActivity.this,"查询失败",Toast.LENGTH_SHORT).show();
                            }
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(DeliverySelectCabActivity.this,"连接服务器失败，请检查网络连接",Toast.LENGTH_SHORT).show();
                    }
                }){
            @Override
